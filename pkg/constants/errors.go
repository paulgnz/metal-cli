...
var (
	ErrNoBlockchainID                 = errors.New("\n\nNo blockchainID found. To resolve this:\n- Use 'metal blockchain deploy' to deploy the blockchain and generate a blockchainID.\n- Or use 'metal blockchain import' to import an existing configuration.\n") //nolint:stylecheck
	ErrNoSubnetID                     = errors.New("\n\nNo subnetID found. To resolve this:\n- Use 'metal blockchain deploy' to create the subnet and generate a subnetID.\n- Or use 'metal blockchain import' to import an existing configuration.\n")             //nolint:stylecheck
