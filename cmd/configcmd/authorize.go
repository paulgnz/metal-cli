...
func handleAuthorizeCloudAccess(_ *cobra.Command, args []string) error {
	...
	case constants.Enable:
		ux.Logger.PrintToUser("Thank you for authorizing Metal CLI to access your Cloud account(s)")
		ux.Logger.PrintToUser("By enabling this setting you are authorizing Metal CLI to:")
	...
	case constants.Disable:
		ux.Logger.PrintToUser("Metal CLI Cloud access has been disabled.")
		ux.Logger.PrintToUser("You can re-enable Cloud access by running 'metal config authorize-cloud-access enable'")
